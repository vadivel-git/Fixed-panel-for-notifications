var App = {
    init: function() {
      Helpers.init(), $(".template-customers-login")[0] ? AccountLogin.init() : $(".template-customers-account")[0] ? CustomerAccount.init() : $(".template-product")[0] ? Product.init() : $("#homepageNotification")[0] && Homepage.init()
    }
  },
  Helpers = {
    init: function() {
    ...
    popups: function() {
      $(document).on("click", "[data-popup]", function(t) {
        function e() {
          i.css("display", ""), n.remove(), o.parent().off("click.popup")
        }
        t.preventDefault(), t.stopPropagation();
        var o = $(this),
          i = $(o.attr("data-popup")).css("display", "block"),
          n = $('<div class="popup-screen"></div>').appendTo(o.parent());
    ...
    addListeners: function() {
      $(document).on("click", '[data-action="reset-password"]', function(t) {
        var e = $(t.target),
          ...
          i = $(CustomerAccount.RESET_PASS_SUCCESS_TEMPLATE),
          n = e.attr("data-action-value");
        o.find("#customer_email").val(n), o.appendTo(document.body), i.insertAfter(t.target), $(t.target).remove(), o.find("form").submit()
      })
    }
  },
  AccountLogin = {
  ...
  Product = {
    ...
    addListeners: function() {
      $(document).on("shown.bs.collapse", function(t) {
        ...
        "index" == o ? $(".js-iframe").attr("src", "//bootstrap-themes.github.io/" + e + "/") : $(".js-iframe").attr("src", "//bootstrap-themes.github.io/" + e + "/" + o + "/"), $(".js-styleDropdown").html(this.innerText)
      })
    },
  ...
  Homepage = {
    ...
    addListeners: function() {
      $(document).on("click", '[data-action="dismiss-homepageNotification"]', function(t) {
        Homepage.dismissHomepageNotification()
      })
    },
    dismissHomepageNotification: function() {
